...
- Two-phase selection: **108 anchor hubs** ranked by own population with a metro-density-dependent minimum separation (48 mi in dense metros → 155 mi rural), then a **gap-fill pass** that repeatedly adds the best city more than 100 mi from any hub. The fill phase is what closes Montana/Nevada/west-Texas; do not shrink it to buy more anchors.
...
- Ring gradients are deliberately *flat* (0.16 → 0.14 → 0.05). A steep falloff turned 150 overlapping discs into one solid blue field with no readable service areas.
- Label placement tries 8 positions per hub and rejects collisions against other labels, every hub dot, and the AK/HI inset panels. 146 of 150 currently place.
